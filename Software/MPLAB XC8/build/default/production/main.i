...
accumulatorM += error;
pid += I2C_buffer.data.RPM_PID_KI*accumulatorM;
pid += I2C_buffer.data.RPM_PID_KD * (error - lasterrorM);
lasterrorM = error;
if (pid >= 1023)
{
pid = 1023;
...
ANSELA = 0b00000000;
WPUA = 0b00011110;
OPTION_REGbits.nWPUEN = (char) !(I2C_buffer.data.IOWPU & 0x01);
